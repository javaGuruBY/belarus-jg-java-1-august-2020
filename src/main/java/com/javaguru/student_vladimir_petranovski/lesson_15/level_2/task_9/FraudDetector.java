...
class FraudDetector {
    boolean isFraud(Trader trader, String checkName, String checkCity) {
        return isTraderFraudsterByThisName(trader, checkName) &&
                isTraderFraudsterByThisCity(trader, checkCity);
    }

    private boolean isTraderFraudsterByThisName (Trader trader, String checkName) {
        return !trader.getFullName().equals(checkName);
    }

    private boolean isTraderFraudsterByThisCity(Trader trader, String checkCity) {
        return !trader.getCity().equals(checkCity);
    }
}
