package lesson_6.level_6_middle.task_27;
...
class TicTacToe {
    ...
    Move getNextMove() {
        ...
        System.out.println("Enter your VERTICAL coordinate (from 0 to 2):");
        int xCoordinate = reader.nextInt();
        System.out.println("Enter your HORIZONTAL coordinate (from 0 to 2):");
