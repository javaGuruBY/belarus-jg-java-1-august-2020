...
public class TaskTwelve {
    //выполнено
    /*Нюанс. Если делать по инструкции в задании, т.е. пока пишем необходимое в
    класс Robot, то IDEA будет выдавать ошибку
    до тех пор, пока не будет дописан код и в классе RobotDemo
    */
}
