 ...
 */
public class TaskSeventeenBankAccount {
    private String ownerFirstName;
    private String ownerLastName;
    private int moneyAmount;

    public TaskSeventeenBankAccount (String ownerFirstName, String ownerLastName, int moneyAmount) {
        this.ownerFirstName = ownerFirstName;
        this.ownerLastName = ownerLastName;
...
class BankAccountDemo {
    ...
    public static void main(String[] args) {
        TaskSeventeenBankAccount bankAccount = new TaskSeventeenBankAccount("Viktor", "Savonin", 100000);
        String ownerFirstName = bankAccount.getOwnerFirstName();
